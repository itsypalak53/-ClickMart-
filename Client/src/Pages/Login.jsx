    ...
    <div className='flex justify-between items-center h-screen bg-[#FFF9F5] px-24 overflow-hidden'>
      ...
      <div className='w-1/2 flex flex-col items-start px-12'>
        <div className='mb-6'>
          <h1 className='text-4xl font-bold text-slate-900 tracking-tight'>
            Welcome Back to <span className='text-blue-600'>Click</span><span className='text-violet-600'>Mart</span>
          </h1>
      ...
      <div className='w-1/2 flex justify-end'>
        <div className='bg-white shadow-xl rounded-2xl w-[480px] p-8 border border-slate-100'>
          <h2 className='text-3xl font-bold text-center text-blue-600 mb-1'>Welcome Back</h2>
          <p className='text-center text-slate-400 text-xs mb-6'>Please enter your details to sign in.</p>
